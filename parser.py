    ...
    async def main(self):
        ...
        for event in events:
            ...
            for container in containers:
                ...
                image_link = "https://bkz.ru" + container.find('img', class_='playbill-el-img-mobile')['src']
                link = 'https://bkz.ru' + container['href']
                ...
                if time:
                    ...
                    if ' в ' in full_text:
                        ...
                        # logger.debug(link)
                        # logger.debug(dt)
                        await self.register_event(title, link, dt, 'Большой концертный зал "Октябрьский"', image_link)